<?php /* Smarty version 2.6.26, created on 2017-10-23 10:51:51
         compiled from plan/planView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'basename', 'plan/planView.tpl', 15, false),array('modifier', 'replace', 'plan/planView.tpl', 15, false),array('modifier', 'escape', 'plan/planView.tpl', 50, false),array('modifier', 'strip_tags', 'plan/planView.tpl', 90, false),array('modifier', 'strip', 'plan/planView.tpl', 90, false),array('modifier', 'truncate', 'plan/planView.tpl', 90, false),array('function', 'config_load', 'plan/planView.tpl', 16, false),array('function', 'lang_get', 'plan/planView.tpl', 27, false),)), $this); ?>
...
<?php $this->assign('importAction', "lib/plan/planImport.php?tplan_id="); ?>
...
<?php echo lang_get_smarty(array('var' => 'labels','s' => 'testplan_title_tp_management,testplan_txt_empty_list,sort_table_by_column,
          ...
          export_import,export,import,export_testplan_links,import_testplan_links'), $this);?>
...
<?php else: ?>
	<table id='item_view'class="simple sortable">
		<thead>
		<tr>
			<th><?php echo $this->_tpl_vars['tlImages']['toggle_api_info']; ?>
...
"><?php echo $this->_tpl_vars['labels']['export']; ?>
			...
			<th class="<?php echo $this->_tpl_vars['noSortableColumnClass']; ?>
"><?php echo $this->_tpl_vars['labels']['import']; ?>
</th>
		</tr>
		</thead>
		<tbody>
...
" 
 				              src="<?php echo $this->_tpl_vars['tlImages']['edit']; ?>
"/>
 				     <?php endif; ?>  
 				  </a>
			</td>
			...
			<td class="clickable_icon">
				<?php if ($this->_tpl_vars['testplan']['active'] == 1): ?> 
  					<img style="border:none" title="<?php echo $this->_tpl_vars['labels']['alt_active_testplan']; ?>
" alt="<?php echo $this->_tpl_vars['labels']['alt_active_testplan']; ?>
" 
  				       src="<?php echo $this->_tpl_vars['tlImages']['checked']; ?>
"/>
  				<?php else: ?>
  					&nbsp;        
  				<?php endif; ?>
...
<?php echo $this->_tpl_vars['testplan']['id']; ?>
"> 
				  <img style="border:none;cursor: pointer;" alt="<?php echo $this->_tpl_vars['labels']['export_testplan_links']; ?>
" 
				       title="<?php echo $this->_tpl_vars['labels']['export_testplan_links']; ?>
" src="<?php echo $this->_tpl_vars['tlImages']['export']; ?>
"/>
				  </a>     
			</td>
			<td class="clickable_icon">
			    <a href="<?php echo $this->_tpl_vars['importAction']; ?>
<?php echo $this->_tpl_vars['testplan']['id']; ?>
"> 
				  <img style="border:none;cursor: pointer;" alt="<?php echo $this->_tpl_vars['labels']['import_testplan_links']; ?>
" 
				       title="<?php echo $this->_tpl_vars['labels']['import_testplan_links']; ?>
"  src="<?php echo $this->_tpl_vars['tlImages']['import']; ?>
"/>
				  </a>     
			</td>
		</tr>
