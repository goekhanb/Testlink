<?php /* Smarty version 2.6.26, created on 2017-10-26 16:18:12
         compiled from testcases/tcAssign2Tplan.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'lang_get', 'testcases/tcAssign2Tplan.tpl', 10, false),array('modifier', 'escape', 'testcases/tcAssign2Tplan.tpl', 20, false),)), $this); ?>
...
//BUGID 3943: Escape all messages (string)
	var check_msg="<?php echo ((is_array($_tmp=$this->_tpl_vars['labels']['please_select_one_testplan'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'javascript') : smarty_modifier_escape($_tmp, 'javascript')); ?>
";
