<?php /* Smarty version 2.6.26, created on 2017-10-24 12:43:14
         compiled from plan/buildView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'basename', 'plan/buildView.tpl', 12, false),array('modifier', 'replace', 'plan/buildView.tpl', 12, false),array('modifier', 'escape', 'plan/buildView.tpl', 42, false),array('modifier', 'strip_tags', 'plan/buildView.tpl', 70, false),array('modifier', 'strip', 'plan/buildView.tpl', 70, false),array('modifier', 'truncate', 'plan/buildView.tpl', 70, false),array('function', 'config_load', 'plan/buildView.tpl', 13, false),array('function', 'lang_get', 'plan/buildView.tpl', 22, false),array('function', 'localize_date', 'plan/buildView.tpl', 71, false),)), $this); ?>
...
"><?php echo ((is_array($_tmp=$this->_tpl_vars['build']['name'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
  					     ...
  					     <?php if ($this->_tpl_vars['gsmarty_gui']->show_icon_edit): ?>
  					         <img style="border:none" alt="<?php echo $this->_tpl_vars['labels']['alt_edit_build']; ?>
" title="<?php echo $this->_tpl_vars['labels']['alt_edit_build']; ?>
"
...
<?php endif; ?></td>
  				<td class="clickable_icon">
  				   <?php if ($this->_tpl_vars['build']['active'] == 1): ?> 
  				     <img style="border:none"  title="<?php echo $this->_tpl_vars['labels']['alt_active_build']; ?>
...
"/>
  				...
  				<td class="clickable_icon">
  				   <?php if ($this->_tpl_vars['build']['is_open'] == 1): ?> 
  				     <img style="border:none"  title="<?php echo $this->_tpl_vars['labels']['alt_open_build']; ?>
...
"/>
  				...
  				<td class="clickable_icon">
				       <img style="border:none;cursor: pointer;"  title="<?php echo $this->_tpl_vars['labels']['alt_delete_build']; ?>
" 
