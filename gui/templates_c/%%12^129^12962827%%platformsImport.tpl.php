<?php /* Smarty version 2.6.26, created on 2017-10-26 15:25:48
         compiled from platforms/platformsImport.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'lang_get', 'platforms/platformsImport.tpl', 9, false),array('function', 'config_load', 'platforms/platformsImport.tpl', 15, false),array('function', 'html_options', 'platforms/platformsImport.tpl', 70, false),array('modifier', 'basename', 'platforms/platformsImport.tpl', 14, false),array('modifier', 'replace', 'platforms/platformsImport.tpl', 14, false),array('modifier', 'escape', 'platforms/platformsImport.tpl', 23, false),)), $this); ?>

<?php echo lang_get_smarty(array('var' => 'labels','s' => 'file_type,view_file_format_doc,local_file,warning,
             max_size_cvs_file1,max_size_cvs_file2,btn_upload_file,
             btn_goback,not_imported,warning_empty_filename,imported,btn_cancel'), $this);?>


<?php $this->assign('cfg_section', ((is_array($_tmp=((is_array($_tmp='platforms/platformsImport.tpl')) ? $this->_run_mod_handler('basename', true, $_tmp) : basename($_tmp)))) ? $this->_run_mod_handler('replace', true, $_tmp, ".tpl", "") : smarty_modifier_replace($_tmp, ".tpl", ""))); ?>
...
"/>
    	...
    	<p><?php echo $this->_tpl_vars['gui']->max_size_import_file_msg; ?>
</p>
    	<div class="groupBtn">
    		<input type="hidden" name="doAction" id="doAction" value="doImport" />
    		<input type="hidden" name="goback_url" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['gui']->goback_url)) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
" />
