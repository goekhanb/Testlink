<?php /* Smarty version 2.6.26, created on 2017-10-24 12:36:26
         compiled from plan/buildEdit.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'lang_get', 'plan/buildEdit.tpl', 27, false),array('function', 'config_load', 'plan/buildEdit.tpl', 61, false),array('function', 'localize_date', 'plan/buildEdit.tpl', 102, false),array('function', 'html_options', 'plan/buildEdit.tpl', 136, false),array('modifier', 'escape', 'plan/buildEdit.tpl', 41, false),array('modifier', 'basename', 'plan/buildEdit.tpl', 60, false),array('modifier', 'replace', 'plan/buildEdit.tpl', 60, false),)), $this); ?>
...
";
var warning_empty_build_name = "<?php echo ((is_array($_tmp=$this->_tpl_vars['labels']['warning_empty_build_name'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'javascript') : smarty_modifier_escape($_tmp, 'javascript')); ?>
";
<?php echo '
...
>
    ...
    <tr>
		    ...
		    <td>
				       ...
				       value="<?php echo $this->_tpl_vars['gui']->release_date; ?>
" />
				<img title="<?php echo $this->_tpl_vars['labels']['show_calender']; ?>
" src="<?php echo @TL_THEME_IMG_DIR; ?>
/calendar.gif"
				     onclick="showCal('release_date-cal','release_date','<?php echo $this->_tpl_vars['gsmarty_datepicker_format']; ?>
');" >
