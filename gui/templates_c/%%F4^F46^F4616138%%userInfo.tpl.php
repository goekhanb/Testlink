<?php /* Smarty version 2.6.26, created on 2017-10-23 10:21:58
         compiled from usermanagement/userInfo.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'config_load', 'usermanagement/userInfo.tpl', 8, false),array('function', 'lang_get', 'usermanagement/userInfo.tpl', 10, false),array('function', 'html_options', 'usermanagement/userInfo.tpl', 160, false),array('function', 'localize_timestamp', 'usermanagement/userInfo.tpl', 224, false),array('modifier', 'escape', 'usermanagement/userInfo.tpl', 30, false),)), $this); ?>
...
var warning_empty_pwd = "<?php echo ((is_array($_tmp=$this->_tpl_vars['labels']['warning_empty_pwd'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'javascript') : smarty_modifier_escape($_tmp, 'javascript')); ?>
";
var warning_different_pwd = "<?php echo ((is_array($_tmp=$this->_tpl_vars['labels']['warning_different_pwd'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'javascript') : smarty_modifier_escape($_tmp, 'javascript')); ?>
";
var warning_enter_less1 = "<?php echo ((is_array($_tmp=$this->_tpl_vars['labels']['warning_enter_less1'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'javascript') : smarty_modifier_escape($_tmp, 'javascript')); ?>
";
var warning_enter_at_least1 = "<?php echo ((is_array($_tmp=$this->_tpl_vars['labels']['warning_enter_at_least1'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'javascript') : smarty_modifier_escape($_tmp, 'javascript')); ?>
";
var warning_enter_at_least2 = "<?php echo ((is_array($_tmp=$this->_tpl_vars['labels']['warning_enter_at_least2'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'javascript') : smarty_modifier_escape($_tmp, 'javascript')); ?>
";
var warning_enter_less2 = "<?php echo ((is_array($_tmp=$this->_tpl_vars['labels']['warning_enter_less2'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'javascript') : smarty_modifier_escape($_tmp, 'javascript')); ?>
";
...
";
var warning_empty_name = "<?php echo ((is_array($_tmp=$this->_tpl_vars['labels']['warning_empty_first_name'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'javascript') : smarty_modifier_escape($_tmp, 'javascript')); ?>
";
var warning_empty_last = "<?php echo ((is_array($_tmp=$this->_tpl_vars['labels']['warning_empty_last_name'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'javascript') : smarty_modifier_escape($_tmp, 'javascript')); ?>
";
var warning_passwd_dont_match = "<?php echo ((is_array($_tmp=$this->_tpl_vars['labels']['passwd_dont_match'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'javascript') : smarty_modifier_escape($_tmp, 'javascript')); ?>
";
var warning_empty_old_password = "<?php echo ((is_array($_tmp=$this->_tpl_vars['labels']['empty_old_passwd'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'javascript') : smarty_modifier_escape($_tmp, 'javascript')); ?>
";
var warning_empty_email_address = "<?php echo ((is_array($_tmp=$this->_tpl_vars['labels']['empty_email_address'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'javascript') : smarty_modifier_escape($_tmp, 'javascript')); ?>
";
var warning_no_good_email_address = "<?php echo ((is_array($_tmp=$this->_tpl_vars['labels']['no_good_email_address'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'javascript') : smarty_modifier_escape($_tmp, 'javascript')); ?>
"; 
