<?php /* Smarty version 2.6.26, created on 2017-10-30 12:52:36
         compiled from mainPageLeft.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'lang_get', 'mainPageLeft.tpl', 13, false),)), $this); ?>
  ...
  <div id="menu_left_block_5"></div><br />
    ...
    <div id='testproject_topics'>
	  <?php if ($this->_tpl_vars['gui']->grants['project_edit'] == 'yes'): ?>
  		<img src="<?php echo $this->_tpl_vars['tlImages']['bullet']; ?>
" />
...
" />
		...
		<?php endif; ?>
                ...
                <div id='ghost-inspector'>
            <img src="<?php echo $this->_tpl_vars['tlImages']['bullet']; ?>
"/>
            <a href="custom/platforms/ghostInspectorView.php">
                Start Ghost Inspector
            </a>
        </div>
    </div>
	<?php endif; ?>
