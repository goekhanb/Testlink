<?php /* Smarty version 2.6.26, created on 2017-10-24 12:13:09
         compiled from testcases/tcDelete.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'lang_get', 'testcases/tcDelete.tpl', 23, false),array('modifier', 'escape', 'testcases/tcDelete.tpl', 29, false),)), $this); ?>
<?php echo lang_get_smarty(array('var' => 'labels','s' => 'btn_yes_iw2del,btn_no,th_version,th_linked_to_tplan,title_delete_testcases,
             th_executed,question_del_tc,platform'), $this);?>
...
<?php if ($this->_tpl_vars['gui']->sqlResult == ''): ?>
	<?php if ($this->_tpl_vars['gui']->delete_mode == 'single'): ?>
	  <?php if ($this->_tpl_vars['gui']->exec_status_quo != ''): ?>
	      <table class="simple" >
	  		<tr>
	  			...
	  			<?php if ($this->_tpl_vars['gui']->display_platform): ?><th><?php echo $this->_tpl_vars['labels']['platform']; ?>
</th> <?php endif; ?>
...
?>
	  			    <tr>
	  			      ...
	  			      <?php if ($this->_tpl_vars['gui']->display_platform): ?>
