...
";
var warning_empty_login      = "<?php echo ((is_array($_tmp=$this->_tpl_vars['labels']['warning_empty_login'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'javascript') : smarty_modifier_escape($_tmp, 'javascript')); ?>
";
var warning_empty_first_name = "<?php echo ((is_array($_tmp=$this->_tpl_vars['labels']['warning_empty_first_name'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'javascript') : smarty_modifier_escape($_tmp, 'javascript')); ?>
";
var warning_empty_last_name  = "<?php echo ((is_array($_tmp=$this->_tpl_vars['labels']['warning_empty_last_name'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'javascript') : smarty_modifier_escape($_tmp, 'javascript')); ?>
";
