<?php /* Smarty version 2.6.26, created on 2017-10-23 10:51:46
         compiled from usermanagement/usersAssign.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'lang_get', 'usermanagement/usersAssign.tpl', 18, false),array('function', 'cycle', 'usermanagement/usersAssign.tpl', 201, false),array('modifier', 'escape', 'usermanagement/usersAssign.tpl', 123, false),)), $this); ?>
...
" 
    	...
    	<?php if ($this->_tpl_vars['gui']->featureType == 'testproject'): ?>
   		<tr>
   		<td class="labelHolder"><?php echo $this->_tpl_vars['labels']['show_only_authorized_users']; ?>
</td><td>&nbsp;</td>
      <td> 
          <input name="show_only_authorized_users" id="show_only_authorized_users" 
                  type="checkbox" <?php echo $this->_tpl_vars['checked_hide_inactive_users']; ?>
...
?>
    	    <?php $this->assign('globalRoleName', $this->_tpl_vars['user']->globalRole->name); ?>
    			<?php $this->assign('uID', $this->_tpl_vars['user']->dbID); ?>
                    ...
                    <?php $this->assign('effective_role_id', $this->_tpl_vars['gui']->userFeatureRoles[$this->_tpl_vars['uID']]['effective_role_id']); ?>
          <?php if ($this->_tpl_vars['gui']->userFeatureRoles[$this->_tpl_vars['uID']]['is_inherited'] == 1): ?>
            <?php $this->assign('ikx', $this->_tpl_vars['effective_role_id']); ?>
          <?php else: ?>
          ...
          <?php if ($this->_tpl_vars['effective_role_id'] == @TL_ROLES_NO_RIGHTS): ?>
            <?php $this->assign('user_row_class', 'class="not_authorized_user"'); ?>
          <?php endif; ?>
