<?php /* Smarty version 2.6.26, created on 2017-10-23 10:24:26
         compiled from events/eventviewer.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'basename', 'events/eventviewer.tpl', 12, false),array('modifier', 'replace', 'events/eventviewer.tpl', 12, false),array('modifier', 'escape', 'events/eventviewer.tpl', 38, false),array('modifier', 'date_format', 'events/eventviewer.tpl', 191, false),array('function', 'config_load', 'events/eventviewer.tpl', 13, false),array('function', 'lang_get', 'events/eventviewer.tpl', 15, false),)), $this); ?>
...
" 
			       onclick="showCal('startDate-cal','startDate','<?php echo $this->_tpl_vars['gsmarty_datepicker_format']; ?>
');" readonly/>
...
" 
			       onclick="showCal('endDate-cal','endDate','<?php echo $this->_tpl_vars['gsmarty_datepicker_format']; ?>
');" readonly/>
			<img title="<?php echo $this->_tpl_vars['labels']['show_calender']; ?>
" src="<?php echo @TL_THEME_IMG_DIR; ?>
/calendar.gif"
