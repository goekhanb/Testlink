<?php /* Smarty version 2.6.26, created on 2017-10-24 10:59:12
         compiled from platforms/platformsView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'lang_get', 'platforms/platformsView.tpl', 14, false),array('function', 'config_load', 'platforms/platformsView.tpl', 39, false),array('modifier', 'basename', 'platforms/platformsView.tpl', 38, false),array('modifier', 'replace', 'platforms/platformsView.tpl', 38, false),array('modifier', 'escape', 'platforms/platformsView.tpl', 60, false),array('modifier', 'nl2br', 'platforms/platformsView.tpl', 65, false),)), $this); ?>
...
<?php if ($this->_tpl_vars['gui']->platforms != ''): ?>
	<table class="simple sortable">
		<tr>
			<th width="30%"><?php echo $this->_tpl_vars['tlImages']['toggle_api_info']; ?>
<?php echo $this->_tpl_vars['tlImages']['sort_hint']; ?>
...
">
			...
			<td class="clickable_icon">
				...
				<img style="border:none;cursor: pointer;"	alt="<?php echo $this->_tpl_vars['labels']['alt_delete_platform']; ?>
"
...
', '<?php echo ((is_array($_tmp=$this->_tpl_vars['del_msgbox_title'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'javascript') : smarty_modifier_escape($_tmp, 'javascript')); ?>
','<?php echo ((is_array($_tmp=$this->_tpl_vars['warning_msg'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'javascript') : smarty_modifier_escape($_tmp, 'javascript')); ?>
');" />
				<?php else: ?>
					<img style="border:none;cursor: pointer;" 	alt="<?php echo $this->_tpl_vars['labels']['alt_delete_platform']; ?>
"
						title="<?php echo $this->_tpl_vars['labels']['alt_delete_platform']; ?>
"	src="<?php echo $this->_tpl_vars['tlImages']['delete_disabled']; ?>
"
						onclick="alert_message_html('<?php echo ((is_array($_tmp=$this->_tpl_vars['del_msgbox_title'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'javascript') : smarty_modifier_escape($_tmp, 'javascript')); ?>
','<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['warning_msg_cannot_del'])) ? $this->_run_mod_handler('replace', true, $_tmp, '%s', $this->_tpl_vars['gui']->platforms[$this->_sections['platform']['index']]['name']) : smarty_modifier_replace($_tmp, '%s', $this->_tpl_vars['gui']->platforms[$this->_sections['platform']['index']]['name'])))) ? $this->_run_mod_handler('escape', true, $_tmp, 'javascript') : smarty_modifier_escape($_tmp, 'javascript')); ?>
');" />
				<?php endif; ?>
			</td>
			<?php endif; ?>
 ...
 <?php endif; ?>
	...
	<div class="groupBtn">	
   		<form style="float:left" name="platform_view" id="platform_view" method="post" action="lib/platforms/platformsEdit.php">
		  	...
		  	<?php if ($this->_tpl_vars['gui']->canManage != ""): ?>
		    	<input type="submit" id="create_platform" name="create_platform" 	value="<?php echo $this->_tpl_vars['labels']['btn_create_platform']; ?>
"
