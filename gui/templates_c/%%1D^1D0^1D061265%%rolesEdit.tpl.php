<?php /* Smarty version 2.6.26, created on 2017-10-23 10:53:45
         compiled from usermanagement/rolesEdit.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'lang_get', 'usermanagement/rolesEdit.tpl', 28, false),array('function', 'config_load', 'usermanagement/rolesEdit.tpl', 66, false),array('modifier', 'escape', 'usermanagement/rolesEdit.tpl', 37, false),array('modifier', 'basename', 'usermanagement/rolesEdit.tpl', 65, false),array('modifier', 'replace', 'usermanagement/rolesEdit.tpl', 65, false),)), $this); ?>
...
";
var warning_modify_role = "<?php echo ((is_array($_tmp=$this->_tpl_vars['labels']['warning_modify_role'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'javascript') : smarty_modifier_escape($_tmp, 'javascript')); ?>
";
var warning_empty_role_name = "<?php echo ((is_array($_tmp=$this->_tpl_vars['labels']['warning_empty_role_name'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'javascript') : smarty_modifier_escape($_tmp, 'javascript')); ?>
";
var warning_error_role_no_rights = "<?php echo ((is_array($_tmp=$this->_tpl_vars['labels']['error_role_no_rights'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'javascript') : smarty_modifier_escape($_tmp, 'javascript')); ?>
";
<?php echo '
