<?php /* Smarty version 2.6.26, created on 2017-10-24 10:22:28
         compiled from cfields/cfieldsView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'basename', 'cfields/cfieldsView.tpl', 12, false),array('modifier', 'replace', 'cfields/cfieldsView.tpl', 12, false),array('modifier', 'escape', 'cfields/cfieldsView.tpl', 50, false),array('function', 'config_load', 'cfields/cfieldsView.tpl', 13, false),array('function', 'lang_get', 'cfields/cfieldsView.tpl', 24, false),)), $this); ?>
...
"><?php echo ((is_array($_tmp=$this->_tpl_vars['cf_def']['name'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
   	...
   	<td align="center"><?php if ($this->_tpl_vars['cf_def']['enable_on_design'] == 1): ?><img src="<?php echo $this->_tpl_vars['tlImages']['checked']; ?>
"><?php endif; ?> </td>
   	<td align="center"><?php if ($this->_tpl_vars['cf_def']['show_on_execution'] == 1): ?><img src="<?php echo $this->_tpl_vars['tlImages']['checked']; ?>
"><?php endif; ?> </td>
   	<td align="center"><?php if ($this->_tpl_vars['cf_def']['enable_on_execution'] == 1): ?><img src="<?php echo $this->_tpl_vars['tlImages']['checked']; ?>
"><?php endif; ?> </td>
   	<td align="center"><?php if ($this->_tpl_vars['cf_def']['enable_on_testplan_design'] == 1): ?><img src="<?php echo $this->_tpl_vars['tlImages']['checked']; ?>
"><?php endif; ?> </td>
